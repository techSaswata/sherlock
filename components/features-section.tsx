...
const features = [
  {
    ...
    description:
      "Analyze videos from YouTube, TikTok, and social media for deepfakes, manipulations, and misleading edits with frame-by-frame AI detection.",
  ...
  },
  {
    ...
    description:
      "Detect photo manipulations, AI-generated images, and edited content from Instagram, Twitter, and news sources instantly.",
    demo: AnimatedEmailDemo,
    size: "medium",
  },
  {
    title: "Article Fact-Checking",
    description:
      "Verify claims in blog posts and news articles by cross-referencing multiple sources and identifying misleading information.",
  ...
  },
  {
    ...
    description:
      "Evaluate the reliability of content sources, checking domain reputation, author credentials, and historical accuracy.",
  ...
  },
  {
    ...
    description:
      "Get clear authenticity scores from 0-100 with detailed breakdowns of what factors influenced the assessment.",
    demo: AnimatedChatDemo,
    size: "medium",
  },
  {
    ...
    description:
      "Receive comprehensive reports with supporting evidence, source citations, and clear explanations of findings.",
    demo: AnimatedEmailDemo,
    size: "medium",
  },
]
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
              Our AI analyzes every aspect of digital content to determine authenticity, providing you with confidence
              scores and evidence-backed reports.
            </p>
          </div>
