    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-balance mb-6 animate-fade-in-heading">
          <span className="text-foreground">Verify what you see.</span>
          <br />
          <span className="inline-flex items-center justify-center flex-wrap gap-2 mt-4 sm:mt-6 md:mt-8">
            <span className="text-foreground">Trust what's</span>
            <RotatingText
              texts={["True", "Real", "Authentic", "Verified", "Factual"]}
        ...
        <p className="text-base sm:text-xl md:text-2xl text-white text-balance max-w-sm sm:max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 sm:px-0 animate-fade-in-subheading font-light">
          Analyze videos, images, and articles from YouTube, Instagram, and blogs to assess their authenticity. Simply
          paste a link and get evidence-backed judgments on what's real or misleading.
        </p>
        ...
        <div className="text-center px-4 hidden sm:block overflow-hidden animate-fade-in-trust">
          <p className="text-sm text-white mb-6">Trusted by journalists, researchers, and fact-checkers worldwide</p>
          <div className="relative overflow-hidden w-full max-w-4xl mx-auto">
            <div className="flex items-center gap-8 opacity-60 hover:opacity-80 transition-all duration-500 animate-slide-left">
              <div className="flex items-center gap-8 whitespace-nowrap">
                <div className="text-base sm:text-lg font-semibold">NewsVerify</div>
                <div className="text-base sm:text-lg font-semibold">FactCheck Pro</div>
                <div className="text-base sm:text-lg font-semibold">MediaWatch</div>
                <div className="text-base sm:text-lg font-semibold">TruthLens</div>
                <div className="text-base sm:text-lg font-semibold">VerifyHub</div>
                <div className="text-base sm:text-lg font-semibold">ContentGuard</div>
              </div>
          ...
          <div className="relative overflow-hidden w-full max-w-sm mx-auto">
            ...
            <div className="flex items-center gap-6 opacity-60 animate-slide-left-mobile">
              <div className="flex items-center gap-6 whitespace-nowrap">
                <div className="text-sm font-semibold">NewsVerify</div>
                <div className="text-sm font-semibold">FactCheck Pro</div>
                <div className="text-sm font-semibold">MediaWatch</div>
                <div className="text-sm font-semibold">TruthLens</div>
                <div className="text-sm font-semibold">VerifyHub</div>
                <div className="text-sm font-semibold">ContentGuard</div>
              </div>
              {/* Duplicate for seamless loop */}
              <div className="flex items-center gap-6 whitespace-nowrap">
                <div className="text-sm font-semibold">NewsVerify</div>
